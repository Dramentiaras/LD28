	...
	public static void renderLogo(float x, float y) {
		...
		GL11.glPushMatrix();
		{
			...
			GL11.glBegin(GL11.GL_QUADS);
			{
				...
				GL11.glTexCoord2f(1 - var0, 0 - var1); GL11.glVertex2f(400, 0);
				GL11.glTexCoord2f(0 - var0, 0 - var1); GL11.glVertex2f(0, 0);
				GL11.glTexCoord2f(0 - var0, 1 - var1); GL11.glVertex2f(0, 150);
				GL11.glTexCoord2f(1 - var0, 1 - var1); GL11.glVertex2f(400, 150);
